...
import 'widgets.dart';
class CountryTab_Page extends StatefulWidget {
  final Country country;
  CountryTab_Page({Key key, @required this.country})
      : assert(country != null),
        super(key: key);
  @override
  _CountryTab_PageState createState() => _CountryTab_PageState();
}

class _CountryTab_PageState extends State<CountryTab_Page> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    muchDelayedAnimayion = Tween(begin: -1.0,end: 0.0).animate(
        CurvedAnimation(parent: animationController,
